...
class _MofifierOffreState extends State<MofifierOffre> {
  ...
  Future<void> ModifierOffre() async {
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      _showDialog(context,"la modification de l'offre de stage ${NomOffre.text} est términer avec succée. ",AlertError);
    }else{
      setState(() {
      AlertError=true;
      });
      _showDialog(context,"la modification de l'offre de stage a échoué",AlertError);
    }
  }
