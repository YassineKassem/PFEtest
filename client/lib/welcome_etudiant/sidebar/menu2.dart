                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        MediaQuery.of(context).orientation== Orientation.portrait ? blocProfilePortrait() : blocProfileLandscape()
                      ],
                    ),
                  Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        navigatorTitle(name:"Home",key:0,onClick:()=>selectedItem(context,0)),
                        navigatorTitle(name:"Profile",key:1,onClick:()=>selectedItem(context,0)),
                        navigatorTitle(name:"Favoris",key:2,onClick:()=>selectedItem(context,0)),
                        navigatorTitle(name:"Postulation",key:3,onClick:()=>selectedItem(context,0)),
                      ],
                    ),
                    MediaQuery.of(context).orientation== Orientation.portrait ? bloclogoutPortrait() : bloclogoutLandscape()
...
Widget navigatorTitle({required String name,required int key,VoidCallback? onClick})
  { 
    return InkWell(
      onTap:onClick,
      child: Row(
